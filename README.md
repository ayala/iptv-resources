...
- `epg/dominican/guia-forge.xml.gz` — compressed 14-day Dominican guide generated by Guía Forge

Hosted feed URL:

```text
https://raw.githubusercontent.com/ayala/iptv-resources/main/epg/dominican/guia-forge.xml.gz
```
